    ...
    >
      ...
      <div className="m-auto w-full  lg:mt-48  ">
        <div className="">
          ...
          <div
            className="flex flex-col gap-8 mt-8 z-10"
            id="kagura-CTT-description "
          >
            <motion.div
              initial={{ opacity: 0 }}
              whileInView={{
            ...
            >
              ...
              >
                ...
                <div className="w-full ">
                  <h1 className=" font-bold text-center text-5xl pt-16 ">
                    CTT
                  </h1>
                  <p id="about-us-paragraph" className=" p-9 text-xl   ">
                    ...
                    APIIT! As we bring together the humor, insight, and warmth
                    of our college community, be ready for a game show unlike
                    ...
                    that will have you on the edge of your seat, featuring
                    faculty members, students, alumni, and special guests. Join
                    us for "Catalyst Tea Time Live" and get your virtual
                    beverage.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="w-full  ">
                  ...
                  <p id="about-us-paragraph" className=" p-9 text-xl   ">
                    ...
                    presents a boundary-pushing celebration that unites the joy
                    of filming, the wonder of cinematography, and the craft of
                    storytelling for the first time at APIIT. Kagura gives
                    filmmakers a stage on which to excel and experiment with
                    narrative conventions. We cordially invite you to share in
                    the birth of a cinematic tradition within our walls as
                    Catalyst sets new standards with Kagura. Prepare yourself
                    for a feast for the eyes, where tales are told, feelings are
                    expressed, and the essence of filmmaking shines through in
                    every frame. Kagura, where the reel comes to life and
