...
const ManageHomepage = () => {
      ...
      if (
        ...
        if (articleToEdit.articleImage instanceof File) {
          const storageRef = ref(
            storage,
            `CatalystArticleImages/homepage/${
              articleToEdit.articleTitle
            }-${Date.now()}`
          );
  ...
  const handleDelete = async () => {
    ...
    const updatedData = {
      ...
      articleDescription:
        "This is the Article Description and by clicking on the edit button you can edit the article description and save it.",
              ...
              <div className="flex flex-wrap">
                <div className="p-2">
                  <div className="rounded-md p-4">
                    ...
                    />
                    <p
                      className="text-gray-700 text-base mt-14"
